  ...
  return (
    <footer className="bg-gradient-to-b from-black/20 via-[var(--color-primary-green)]/10 to-black/40 text-[var(--color-text-main)] py-16 font-sans">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="md:col-span-4 text-center md:text-right">
            ...
            <ul className="space-y-5 text-lg">
              <li className="flex items-start justify-center md:justify-end gap-4">
                <MapPin size={24} className="text-[var(--color-accent-pop)] mt-1 flex-shrink-0" />
                <span className="text-[var(--color-text-muted)] text-right leading-relaxed">
                  {address}
                </span>
              </li>
              <li className="flex items-center justify-center md:justify-end gap-4">
                <Phone size={24} className="text-[var(--color-accent-pop)]" />
                <a href="tel:+918296889485" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary-light)] transition">
                  +91 82968 89485
                </a>
              </li>
              <li className="flex items-center justify-center md:justify-end gap-4">
                <a
                  ...
                  className="text-[var(--color-text-muted)] hover:text-[var(--color-primary-light)] transition flex items-center gap-3"
                >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[var(--color-primary-light)]/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-[var(--color-text-muted)]/80 text-sm">
            <p>
